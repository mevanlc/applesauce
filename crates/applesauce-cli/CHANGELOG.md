...
- Keep the final compression summary visible with one `-q`; suppress it with `-qq`.
...
### Other
- Update Cargo.lock dependencies
- *(deps)* Update rand to published 0.10 version in dev dependencies (by @Dr-Emann) - #215

## [0.5.24](https://github.com/Dr-Emann/applesauce/compare/applesauce-cli-v0.5.23...applesauce-cli-v0.5.24) - 2026-02-16

### Other
- *(deps)* Bump the minor-patches group with 4 updates (by @dependabot[bot]) - #211
- *(deps)* Bump the minor-patches group across 1 directory with 5 updates (by @dependabot[bot]) - #210

## [0.5.23](https://github.com/Dr-Emann/applesauce/compare/applesauce-cli-v0.5.22...applesauce-cli-v0.5.23) - 2026-01-26

### Other
- Update Cargo.lock dependencies
- *(deps)* Bump the minor-patches group across 1 directory with 3 updates (by @dependabot[bot]) - #207
...
### Other
- *(deps)* Bump the minor-patches group with 3 updates (by @dependabot[bot]) - #188
- *(deps)* Bump the minor-patches group with 2 updates (by @dependabot[bot]) - #185
- *(deps)* Bump the minor-patches group with 2 updates (by @dependabot[bot]) - #182

## [0.5.20](https://github.com/Dr-Emann/applesauce/compare/applesauce-cli-v0.5.19...applesauce-cli-v0.5.20) - 2025-10-14

### Added
- Avoid refetching per-volume information for each file (by @Dr-Emann) - #179
